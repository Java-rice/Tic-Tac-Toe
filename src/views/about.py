...
class aboutpage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.upper_bar = customtkinter.CTkFrame(
            self.bg_frame, width=550, height=4, fg_color=self.black
        )
        ...
        self.background_label = customtkinter.CTkLabel(
            self.bg_frame, image=self.about_image, text=""
        )
        self.background_label.place(x=100, y=25)
        self.about = customtkinter.CTkLabel(
            self.bg_frame, text="About", font=self.font2, text_color=self.black
        )
        ...
        # what is tic-tac-toe
        self.what_is_TTT = customtkinter.CTkLabel(
            self.bg_frame,
        ...
        self.TTT_text = customtkinter.CTkTextbox(
            self.bg_frame,
            wrap="word",
            font=self.font1,
            width=400,
        ...
        self.TTT_text.insert(
            "0.0",
            text="Tic-Tac-Toe, also known as Noughts and Crosses, is a classic two-player strategy game typically played on a 3x3 grid. The objective of the game is for one player to form a line of three of their own symbols (either 'X' or 'O') horizontally, vertically, or diagonally, before the opponent does.",
        )

        # instructions
        self.inst_label = customtkinter.CTkLabel(
            self.bg_frame, text="Instructions", font=self.font3, text_color=self.black
        )
        self.inst_label.place(x=110, y=290)

        # return_to_welcome
        self.return_welcome = customtkinter.CTkButton(
            self.bg_frame,
            text="Return",
            text_color=self.bg,
            height=37,
