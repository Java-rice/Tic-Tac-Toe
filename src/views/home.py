...
class homepage(tk.Frame):
    ...
    def interface(self):
        ...
        self.about = customtkinter.CTkLabel(self.mainframe, text="", font=self.font2, text_color=self.black)
        ...
        self.reset_button = customtkinter.CTkButton(self.button_container,text = "Reset",  text_color=self.bg, height=37, corner_radius=50, font=self.font4, width = 200,bg_color=self.bg, fg_color=self.blue, command=self.reset_progress)
        self.return_button = customtkinter.CTkButton(self.button_container, height=37,text = "Return",  text_color=self.bg, width = 200, corner_radius=50, font=self.font4,bg_color=self.bg, fg_color=self.blue, command= lambda: self.controller.show_frame(welcome.startpage))
